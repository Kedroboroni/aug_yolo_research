...
class mainWindow(QMainWindow):
    ...
    def clickedOnSidebarButton(self):
        ...
        self.sidebarWidget.label.btnYolo.clicked.connect(lambda: self.workerSpaceWidget.setCurrentIndex(3))
...
if __name__ == "__main__":
    ...
    window = mainWindow()
    window.setWindowTitle("reserch_aug_lern")
    window.setWindowIcon(QPixmap(QImage(rf"ui\icon.jpg")))
